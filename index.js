...
const BAD_REGEX = /(주식처분|신탁계약|계획|예정|검토|가능성|기대|준비중|추진)/i;
const SUPER_INVESTORS = /삼성전자|삼성SDI|삼성벤처|현대자동차|현대차|기아|현대모비스|LG에너지솔루션|LG전자|LG화학|SK하이닉스|SK이노베이션|한화에어로|네이버|NAVER|카카오|KAKAO/i;
...
const HOT_KEYWORDS = new RegExp([
    ...
    '협동\\s*로봇', '자율\\s*주행', 'AMR', 'AGV', '온디바이스\\s*AI', 'LLM'
].join('|'), 'i');
